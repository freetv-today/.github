...
FreeTV is an open-source platform for curating, publishing, browsing, and watching hand-picked television shows and movies from the [Internet Archive](https://archive.org/). The project includes a web-based Viewer for watching content and a graphical Admin Dashboard for organizing and publishing it.
...
MariaDB is authoritative for data managed through the Admin Dashboard. The Viewer does not connect directly to MariaDB. It consumes static JSON artifacts generated by the publication workflow and thumbnail files maintained in the configured public directory.
